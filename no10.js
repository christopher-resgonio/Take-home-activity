...
function AddTransaction(item, type, qty) {
    if (type !== 'in' && type !== 'out') {
        console.log("Invalid trans type. Use 'in' or 'out'.");
        return;
    }
    ...
    console.log(`Trans recorded: ${type} ${qty} of '${item}'`);
}
...
AddTransaction("Monitor", "in", 10);
AddTransaction("Keyboard", "in", 20);
AddTransaction("Monitor", "out", 4);
AddTransaction("Keyboard", "out", 30); 
